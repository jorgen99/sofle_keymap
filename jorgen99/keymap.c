...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,   KC_Z,    KC_X,   KC_C,    KC_V,    KC_B,  KC_MUTE,  KC_MPLY, KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH,   KC_RSFT,
    MO(3),  KC_LALT, KC_LGUI, LT(1,KC_ENT),  LT(3,KC_ESC), LT(2,KC_BSPC), KC_SPC, MO(4), TG(5), OSM(MOD_RCTL|MOD_RSFT|MOD_RGUI)
),
...
[_NUMBERS] = LAYOUT(
  ...
  KC_NO,     KC_NO,      KC_NO,        KC_NO,      KC_NO,         KC_NO,                      KC_NO,         KC_NO,         KC_NO,      KC_NO,      KC_NO,       KC_NO,
    KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO,                                                        KC_BSPC, KC_TRNS, KC_NO, KC_NO, KC_NO
),
