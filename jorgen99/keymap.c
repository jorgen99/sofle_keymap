 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |  L3  | LAlt |  Alt | L1   | / L3    /       \ L2   \  | Spc  |  L4  | TG5  | RCSG |
 *            |      |      |      | Enter|/ Bsp   /         \ Esc  \ | RShft|      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,   KC_Z,    KC_X,   KC_C,    KC_V,    KC_B,  RSG(KC_M),  KC_MPLY, KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH,   KC_RSFT,
        MO(3), KC_LGUI, KC_LALT,  LT(1,KC_ENT),  LT(3,KC_BSPC), LT(2,KC_ESC), RSFT_T(KC_SPC), LT(4,KC_TAB), TG(5), OSM(MOD_RCTL|MOD_RSFT|MOD_RGUI)
),
...
[_SYMBOLS] = LAYOUT(
  ...
  KC_NO,     LSFT(KC_MINS), KC_MINS,       LSFT(KC_0),   LSFT(KC_3), LSFT(KC_SLSH),                KC_NUBS,       LSFT(KC_NUBS), RALT(KC_8), RALT(KC_9), LALT(KC_RBRC), KC_F12,
  KC_NO,     KC_EQL,        LSFT(KC_EQL),  KC_NUHS,      LSFT(KC_2), KC_PMNS,                      LSFT(KC_RBRC), KC_PAST,       LSFT(KC_8), LSFT(KC_9), RALT(KC_2),    KC_NO,
  KC_NO,     LSFT(KC_6),    RALT(KC_MINS), RALT(KC_NUBS), LSFT(KC_7), RALT(KC_4),  KC_NO,   KC_NO, LSFT(KC_COMM), LSFT(KC_DOT),  RALT(KC_7), RALT(KC_0), LSFT(KC_5),    KC_NO,
           KC_NO,    KC_LGUI,          KC_RALT,           KC_TRNS, KC_NO,                          KC_BSPC, KC_DEL,     KC_NO,      KC_NO,    KC_NO
...
[_ARROWS] = LAYOUT(
  ...
  KC_LCTL,   KC_NO,   KC_NO,  LCTL(KC_MINS), LCTL(KC_SLSH),  KC_NO,                         KC_LEFT,       KC_DOWN,       KC_UP,      KC_RGHT,    KC_NO,       KC_NO,
